...
<script>
import { is404, is422 } from "./../shared/utils/response"; //from response.js file
    ...
    submit() {
      ...
      axios
        ...
        .catch(err => {
          ...
          this.error = true; //when this error is true display a bomb
        })
        .then(() => (this.sending = false)); //then finishe
    }
  }
};
</script>
